# Contributing to KitoMapsGoogle
...
3. Make your change. Follow
   [KitoMapsGoogle's engineering standards](https://github.com/WykSofts-Inc/KitoMapsGoogle/blob/main/docs/ENGINEERING_STANDARDS.md) —
